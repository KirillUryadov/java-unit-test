...
public void checkIsAdultWhenAgeIsLessThan18False(){
    ...
    assertEquals("Должно вернуть false, так как пользователь несовершеннолетний", false, isAdult);
}
...
public void checkIsAdultWhenAgeIs18True(){
    ...
    assertEquals("Должно вернуть true, так как пользователь совершеннолетний", true, isAdult);
}
